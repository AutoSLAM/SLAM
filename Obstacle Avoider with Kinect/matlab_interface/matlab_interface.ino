...
/* To have serial communication between Matlab and an Arduino, simply load this 
   file in the Arduino board, initailaise the arduino with a statement in Matlab
   like "a = arduino('COM3');", setup the pins with statements like 
   "a.pinMode(22,'output');", and read or write to the pins
   (Eg: "a.analogWrite(7, 205);") */
...
void setup() {
  ...
  /* make a few pins +5V to use as positive terminal         */
  pinMode(24, OUTPUT);
  pinMode(26, OUTPUT);
  pinMode(42, OUTPUT);
  pinMode(44, OUTPUT);
